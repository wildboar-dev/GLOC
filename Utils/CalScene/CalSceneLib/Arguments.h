...
namespace NVL_App
{
	...
	public:
		Arguments(int index, int blockSize, Vec2i& gridSize, Vec2d& shiftXY, Vec2d& RotYZ, double angle, double distance, Vec2d& focals, Point2d& center, Size& imageSize, int decimals, const string& folder) :
