...
#define min(a,b)	(((a) < (b)) ? (a) : (b))
	...
	void lmdif(void f(int,int, double*,double*,int*,void*),int m,int n,double x[],int msk[],double fvec[],
	...
	int lmdif0(void f(int,int, double*,double*,int*,void*),int m,int n,double x[],int msk[],double fvec[],
		double tol,int *info,int *nfev,void *callback);
